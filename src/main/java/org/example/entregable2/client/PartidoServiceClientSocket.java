...
public class PartidoServiceClientSocket implements Closeable {
    ...
    public List<PartidoDTO> listar() throws IOException {
        String res = send("PARTIDO_LIST");
        ensureOK(res);
    ...
    public PartidoDTO obtener(int id) throws IOException {
        String res = send("PARTIDO_GET|" + id);
        ensureOK(res);
    ...
    public List<PartidoDTO> obtenerPorJornada(int numJornada) throws IOException {
        String res = send("PARTIDO_JORNADA|" + numJornada);
        ensureOK(res);
    ...
    public void registrarResultado(int id, int golesLocal, int golesVisitante) throws IOException {
        String req = "PARTIDO_REGISTRAR|" + id + "|" + golesLocal + "|" + golesVisitante;
        String res = send(req);
        ensureOK(res);
    }
